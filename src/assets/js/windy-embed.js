...
// Used by the Wind page's live wind checker (wind-checker.js) and each spot's
// own page (spot-page.js), so all surfaces render the same live wind widget
// instead of duplicating the URL format in multiple places.
window.WFA_buildWindyEmbedUrl = function (lat, lon, zoom) {
  ...
  return (
    ...
    "&width=650&height=450&zoom=" + (zoom || 8) + "&level=surface&overlay=wind&product=ecmwf" +
